...
#ifndef LIBWETHAIR_CORE_THREAD_UTILS_H_
#define LIBWETHAIR_CORE_THREAD_UTILS_H_
...
class thread_pool {
  ...
  thread_safe_queue<function_wrapper>
 ...
 public:
  const std::vector<std::thread>& get_threads() const { return threads; }
