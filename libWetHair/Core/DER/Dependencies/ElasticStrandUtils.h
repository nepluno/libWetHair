// This code is licensed solely for academic and non-commercial use under the
// terms of the Clear BSD License. The terms of the Clear BSD License are
// provided below. Other licenses may be obtained by contacting the faculty of
// the Columbia Computer Graphics Group or a Columbia University licensing
// officer.
//
...
#ifndef LIBWETHAIR_CORE_DER_DEPENDENCIES_ELASTICSTRANDUTILS_H_
#define LIBWETHAIR_CORE_DER_DEPENDENCIES_ELASTICSTRANDUTILS_H_
